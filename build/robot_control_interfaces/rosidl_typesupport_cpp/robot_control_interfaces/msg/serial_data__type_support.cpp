...
static const _SerialData_type_support_symbol_names_t _SerialData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_interfaces, msg, SerialData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_control_interfaces, msg, SerialData)),
  }
};
...
{
  return &::robot_control_interfaces::msg::rosidl_typesupport_cpp::SerialData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_control_interfaces, msg, SerialData)() {
  return get_message_type_support_handle<robot_control_interfaces::msg::SerialData>();
}
